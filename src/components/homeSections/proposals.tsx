...
import votePropImg from "../../img/vote-proposals.png";
import voteDelegateImg from "../../img/vote-delegate.png";

const transferFeatures = [
  {
    id: 1,
    name: "Create new proposals",
    description:
...
export default function Proposals() {
  return (
    <div className="w-full bg-gray-900">
      <div className="max-w-5xl my-24 mx-auto overflow-hidden lg:rounded-xl bg-gradient-to-b from-[#2e026d] to-[#15162c] py-16 lg:py-24">
        <div className="relative mx-auto max-w-xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="relative">
            <h2 className="text-center text-3xl font-bold leading-8 tracking-tight text-white sm:text-4xl">
              Have your say in the DAO
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-center text-xl text-indigo-200">
